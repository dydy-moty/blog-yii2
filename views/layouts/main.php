...
use app\widgets\ScrollupWidget;
...
<footer class="footer-widget-section">
        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="about-content">Some content
                    </div>
                    <div class="address">
                        <h4 class="text-uppercase">contact Info</h4>

                        <p> 455000/12b Truda Street, MGN, RU</p>

                        <p> Phone: +7 000 00000</p>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2020 <a href="#">Company name, </a> Create by <a href="#">Matvey</a>
                    </div>
                </div>
            </div>
        </div>
